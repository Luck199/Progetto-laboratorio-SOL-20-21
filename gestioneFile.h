...
int aggiungiFile(char * token);//funzione che aggiunge un nuovo file alla struttura dati che simulerà la memoria del server e ritorna 1 in caso di successo, -1 in caso di errore
